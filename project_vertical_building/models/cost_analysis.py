...
class VerticalCostAnalysis(models.Model):
    ...
    stage_ids = fields.One2many(comodel_name='vertical.stage', inverse_name='cost_analysis_id', string='Stage_id',
                                required=False)
    cost_analysis_line_ids = fields.One2many(comodel_name='cost.analysis.line', inverse_name='cost_analysis_id',
                                             string='Cost_analysis_line_ids', required=False)
