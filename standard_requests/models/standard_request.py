...
class StandardRequest(models.Model):
    ...
    capitulo_id = fields.Many2one(comodel_name='capitulo.capitulo', string='Capitulo', required=True)
    subcapitulo_id = fields.Many2one(comodel_name='sub.capitulo', string='Subcapitulo', required=True)
    ...
    def action_insertar_partida(self):
            partida = self.env['partidas.partidas'].create({
                ...
                'fase_principal_id': self.fase_principal_id.id,
