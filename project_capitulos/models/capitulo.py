...
class Capitulo(models.Model):
    ...
    sub_count = fields.Integer(
        string="Cantidad Subcapitulos", required=False, compute="subcapitulos_count"
    )
    ...
    def _onchange_join_number_capitulo(self):
        self.numero_capitulo = (
            str(self.fase_principal_id.numero_fase_principal) + "." + str(self.number)
        )
