...
class Volumetria(models.Model):
    ...
    descripcion_volumetria = fields.Text(
        string="Descripción volumetría", required=False
    )
    ...
    precio_coste_volumetria = fields.Float(
    ...
    def _compute_total(self):
        self.total = (
            self.cantidad_volumetria
            * (self.longitud_volumetria * self.ancho_volumetria * self.alto_volumetria)
            * self.precio_coste_volumetria
        )
