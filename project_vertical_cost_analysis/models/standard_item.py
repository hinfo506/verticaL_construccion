...
class VerticalStandarItem(models.Model):
    _name = 'vertical.standard.item'
    ...
    importe_venta = fields.Float(string='Importe Venta (PVP)', required=False,
                                 compute='_compute_subtotal_descuento',
                                 store=False)
    impuesto_porciento = fields.Float(string='Impuesto en % (ITBIS)', required=False)
    total_impuesto_item = fields.Float(string='Importe ITBIS', required=False,
                                       compute='_compute_subtotal_descuento',
                                       store=False)
    ...
    #     record = super(VerticalStandarItem, self).create(vals)
